 ...
 * This one is an ArrayList of Strings may contain ["Distance", "Average",
 * "Total"].
 * This means that the first line is "Distance", the second line is "Average",
 * and
...
public class TravellingSalesmanGraph extends JFrame {
    ...
    private class Panel extends JPanel {
        ...
        private void paintAxisLines(Graphics graphics) {
            int o = OFFSET / 2;
            graphics.drawLine(o, o, o, TravellingSalesmanGraph.HEIGHT - o);
            graphics.drawLine(o, TravellingSalesmanGraph.HEIGHT - o, TravellingSalesmanGraph.WIDTH - o,
                    TravellingSalesmanGraph.HEIGHT - o);
        }
        ...
        private void paintHorizontalLabels(Graphics2D graphics) {
            ...
            int startX = OFFSET / 2;
            int startY = TravellingSalesmanGraph.HEIGHT - OFFSET / 2;
        ...
        private void paintPlot(Graphics2D graphics, ArrayList<Integer> yValues) {
            ...
            y1 = TravellingSalesmanGraph.HEIGHT - o - (int) (yValues.get(0) / yScale) - r;
            graphics.fillOval(x1, y1, r * 2, r * 2);

            for (int i = 1; i < yValues.size(); i++) {

                x1 = (int) (++x / xScale) + o + r - r;
                y1 = TravellingSalesmanGraph.HEIGHT - o - (int) (yValues.get(i) / yScale) - r;
                x2 = (int) ((x - 1) / xScale) + o + r - r;
                y2 = TravellingSalesmanGraph.HEIGHT - o - (int) (yValues.get(i - 1) / yScale) - r;
        ...
        private void paintLegend(Graphics2D graphics) {
            int startX = (int) ((double) TravellingSalesmanGraph.WIDTH * 0.7);
            int startY = OFFSET / 5;
